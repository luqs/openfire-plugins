...
```
<iq id='v3' from='user@skysea.com' to='123@group.skysea.com' type='get'>
  <query xmlns='http://skysea.com/protocol/disco#items'/>
</iq>
```
...
<iq from='user@skysea.com' to='group.skysea.com' id='v2' type='get'>
	<query xmlns='http://skysea.com/protocol/disco#items'
		   node='http://skysea.com/protocol/group#member' />
</iq>
```
...
```
<iq id='v4' from='user@skysea.com' to='123@group.skysea.com' type='set'>
  <x xmlns='http://skysea.com/protocol/group#member'>
  	<exit>
...
```
<iq type="result" id="v4" from="123@group.skysea.com" to="user@skysea.com"/>
```

#### 例子3.服务向所有圈子成员广播消息

```
<message from='123@group.skysea.com' to='userother@group.skysea.com'>
  <x xmlns='http://skysea.com/protocol/group#member'>
  	<exit>
  		<member username='user' nickname='applyuser' />
  		<reason>大家太吵了，不好意思，我退了先！</reason>
  	</exit>
  </x>
</message>
...
```
<iq from='123@group.skysea.com' to='owner@skysea.com' id='v4' type='result'>
</iq>
```
...
```
<iq from='123@group.skysea.com' to='owner@skysea.com' id='v1' type='result'>
</iq>
```
#### 例子3.服务向圈子成员广播圈子已被摧毁
